(function(){  
  ...
  */
  console.log( '\nOperation 2:' );
  var operation2 = justMod2Or3; 
  
  operation2.reduceRight( function(acumulador,atual){
  ...
  */
  ...
  const reducedNamx = namx.reduce( function(acumulado, item ){
  ...
  */
  console.log( '\nInversed Name:' );
  var inversedName = namx.reduceRight( function(acumulado , item ){
  ...
  */
  ...
  numberObjects.some( function  (item){
  ...
  */
  ...
  numberObjects.lastIndexOf(numberObjects.some( function  (item){
    return item.number === 2 ;
  }) ? 'Existe um objeto { number: 2 } em numberObjects!' : 'Não existe um objeto { number: 2 } em numberObjects :(');
