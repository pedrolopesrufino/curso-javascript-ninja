...
const fstPerson = new Pessoa("Davos", "Seaworth");
const scdPerson = new Pessoa("Roose", "Bolton");
...
console.log(getFullName.call(fstPerson));
console.log(getFullName.call(scdPerson));
...
function sum(...param) {
  ...
  return [...param].reduce(sumReducer);
}
/*
...
*/
console.log("\nEntrada do usuário:");
console.log("Digitaste os valores", ...userEntry);
